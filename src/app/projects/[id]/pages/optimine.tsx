import { BulletList, GridImg, SectionImg, VideoEmbed } from '@/components/projects/PageBlocks';
      ...
      <section className='space-y-6'>
        ...
        <div className='space-y-3'>
          ...
          <p className='font-body text-body leading-relaxed'>
            ...
            were used to define motor and gearbox sizing requirements, which were
            then validated against the driveline's force requirements to confirm
            the selection would hold under worst-case loading conditions.
          </p>
          <div className='flex flex-wrap gap-4 items-start justify-center w-full'>
            <GridImg
